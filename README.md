# Template React Native 73

A React Native 0.73 template project for quick setup and reference.

## How this template was created

```bash
npx @react-native-community/cli init TemplateReactNative73 --version 0.73 --package-name template.reactnative.v73
```
...
| Gradle     | 8.3    | See `android/gradle/wrapper/gradle-wrapper.properties` |
